...
import { X, Wind, Cloud, Bird, Leaf, Calendar, Clock } from 'lucide-react';
...
export default function AddObservationModal({ isOpen, onClose, onSave }: AddObservationModalProps) {
  const [category, setCategory] = useState<'angin' | 'awan' | 'hewan' | 'tanaman'>('angin');
  ...
  const handleCategoryChange = (cat: 'angin' | 'awan' | 'hewan' | 'tanaman') => {
    setCategory(cat);
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              >
                ...
                <span className="text-[10px] font-medium font-sans">Angin</span>
              </button>
              ...
              >
                ...
                <span className="text-[10px] font-medium font-sans">Awan</span>
              </button>
